...
var sign = module.exports = Object.assign(function sign (o) {
  ...
  _signRun: function (o) {
    return new Promise(function signInit (resolve, reject) {
      ...
      // 会话id
      var sessionId = o.sessionData.sessionId
      // 会话秘钥
      var sessionKey = o.sessionData.sessionKey || 'sessionKey'
      // 设备识别号
      var sessionCard = o.sessionData.sessionCard
      // 时间差
      var differenceTime = o.sessionData.differenceTime

      // 授权字符串
      o.Authorization = 'app-auth-v2' + '/' + o.requestId + '/' + sessionId + '/' + sessionCard + '/' + sign.getUTCServerTime(differenceTime) + '/' + '1800'
