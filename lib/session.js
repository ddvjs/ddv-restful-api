...
Object.assign(session, {
      ...
      .then(function (res) {
        return new Promise(function (resolve, reject) {
          ...
          if (sessionData.expires_time !== undefined && sessionData.expires_time !== null) {
            sessionData.expires_time += sessionData.differenceTime
          } else {
  ...
  createCard: function (o) {
    return new Promise(function (resolve, reject) {
      ...
      sessionCard += '-' + sign.md5Hex(uamd5 + userAgent + sessionCard).substr(4, 8)
      ...
      sessionCard += '-' + sign.md5Hex(uamd5 + sessionCard + userAgent).substr(2, 12)
