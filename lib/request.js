...
var nodeHttp, nodeHttps
var url = require('ddv-auth/util/url')
var isWindow = typeof window !== 'undefined' && window.window === window
var noderequire = 'require'

if (typeof window === 'undefined' && typeof global !== 'undefined' && typeof global.global !== 'undefined' && global.global === global && global[noderequire]) {
  try {
    // 防止webpack打包http和https
    nodeHttp = global[noderequire]('http')
    nodeHttps = global[noderequire]('https')
  } catch (e) {}
}
// 发送请求
...
function ajaxbyNode (uri, body, method, headers) {
  return new Promise(function (resolve, reject) {
    ...
    uriOpt = void 0
    // 发送请求
    req = (opt.protocol === 'http:' ? nodeHttp : nodeHttps).request(opt, function (response) {
      var serverRes = {}
      serverRes.body = ''
