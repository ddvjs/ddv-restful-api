  ...
  return new Promise(function (resolve, reject) {
    ...
    xhr.onreadystatechange = function () {
      if (xhr.readyState === 4) {
        ...
        status >= 200 && status < 300 || Object.assign(serverRes, getOftenOpt(o))
  ...
  return new Promise(function (resolve, reject) {
    ...
    req = (opt.protocol === 'http:' ? http : https).request(opt, function (response) {
      ...
      response.on('data', function (data) {
        ...
        serverRes.status = serverRes.statusMessage
        serverRes.statusCode >= 200 && serverRes.statusCode < 300 || Object.assign(serverRes, this)
        serverRes.statusCode >= 200 && serverRes.statusCode < 300 ? resolve(serverRes) : reject(serverRes)
      })
    }.bind(getOftenOpt(opt)))
    if (o.body) {
      req.write(o.body)
    }
