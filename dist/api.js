...
/***/ function(module, exports, __webpack_require__) {
	...
	api.url = __webpack_require__(!(function webpackMissingModule() { var e = new Error("Cannot find module \"./url.js\""); e.code = 'MODULE_NOT_FOUND'; throw e; }()))
	api.Promise = __webpack_require__(!(function webpackMissingModule() { var e = new Error("Cannot find module \"./promise.js\""); e.code = 'MODULE_NOT_FOUND'; throw e; }()))
	api.prototype = api.Promise.prototype
	const request = api.request = __webpack_require__(!(function webpackMissingModule() { var e = new Error("Cannot find module \"./request.js\""); e.code = 'MODULE_NOT_FOUND'; throw e; }()))
	const sign = api.sign = __webpack_require__(!(function webpackMissingModule() { var e = new Error("Cannot find module \"./sign.js\""); e.code = 'MODULE_NOT_FOUND'; throw e; }()))
	const session = api.session = __webpack_require__(!(function webpackMissingModule() { var e = new Error("Cannot find module \"./session.js\""); e.code = 'MODULE_NOT_FOUND'; throw e; }()))
